    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="row pt-2 pb-2">
                <div class="col-sm-9">
                    <h4 class="page-title">Supervisor Profile</h4>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="profile.php"><?php echo $supervisor_name ?></a></li>
                        <li class="breadcrumb-item active" aria-current="page">Supervisor Profile</li>
                    </ol>
                </div>
                <div class="col-sm-3">
                    <a href="home.php">
                    ...
                    <div class="profile-card-3">
                        <div class="card">
                            <div class="user-fullimage">
                                ...
                                <div class="details">
                                    <h5 class="mb-1 text-white ml-3"><?php echo $supervisor_name ?></h5>
                                    <h6 class="text-white ml-3">Supervisor</h6>
                                </div>
                            </div>
                            <div class="card-body text-center">
                                <hr>
                                <a href="../sessions/supervisor_logout.php"
