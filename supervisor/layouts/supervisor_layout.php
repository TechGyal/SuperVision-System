...
<div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
    ...
    <ul class="sidebar-menu do-nicescrol">
        ...
        <li>
            <a href="../sessions/supervisor_logout.php" class="waves-effect"><i class="fa fa-lock text-danger"></i> <span>Logout</span></a>
        </li>
    </ul>
...
<!--                </div>-->
            ...
            <li class="nav-item">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                    ...
                    <li class="dropdown-divider"></li>
                    <li class="dropdown-item"><a href="../sessions/supervisor_logout.php"><i class="icon-power mr-2"></i> Logout</a></li>
                </ul>
            </li>
        </ul>
    </nav>
