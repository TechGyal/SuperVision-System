    ...
    <nav class="navbar navbar-expand fixed-top bg-white">
        ...
        <ul class="navbar-nav align-items-center right-nav-link">
            <li class="nav-item dropdown-lg">
                <a class="nav-link dropdown-toggle dropdown-toggle-nocaret waves-effect" data-toggle="dropdown" href="../mailbox/inbox.php">
                    <i class="icon-bell"></i><span class="badge badge-primary badge-up"><?php echo number_format($unReadNotifications) ?></span></a>
...
<!--                </div>-->
            ...
            <li class="nav-item">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                    ...
                    <li class="dropdown-item"><a href="../dashboard/profile.php"><i class="icon-wallet mr-2"></i> Account</a></li>
                    <li class="dropdown-divider"></li>
                    <li class="dropdown-item"><a href="../sessions/student_logout.php"><i class="icon-power mr-2"></i> Logout</a></li>
                </ul>
            </li>
        </ul>
    </nav>
