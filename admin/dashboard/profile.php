        ...
        <div class="container-fluid">
            ...
            <div class="row pt-2 pb-2">
                <div class="col-sm-9">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="profile.php"><?php echo $admin_name ?></a></li>
                    ...
                    <div class="profile-card-3">
                        <div class="card">
                            <div class="user-fullimage">
                                ...
                                <div class="details">
                                    <h5 class="mb-1 text-white ml-3"><?php echo $admin_name ?></h5>
                                    <h6 class="text-white ml-3">System Administrator</h6>
                                </div>
                            </div>
