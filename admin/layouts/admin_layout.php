...
<div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
    ...
    <ul class="sidebar-menu do-nicescrol">
        ...
        <li>
            ...
            <ul class="sidebar-submenu">
                <li><a href="../dashboard/addSupervisor.php"><i class="fa fa-circle-o"></i> Add Supervisor</a></li>
                <li><a href="../dashboard/viewSupervisor.php"><i class="fa fa-circle-o"></i> View Supervisor(s)</a></li>
            </ul>
        </li>
        <li>
            <a href="javaScript:void();" class="waves-effect">
            ...
            <li class="nav-item">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                    ...
                    <li class="dropdown-item"><a href="../dashboard/profile.php"><i class="icon-wallet mr-2"></i>
                            Account</a></li>
                    <li class="dropdown-divider"></li>
                    <li class="dropdown-item"><a href="../sessions/admin_logout.php"><i class="icon-power mr-2"></i>
                            Logout</a></li>
                </ul>
            </li>
        </ul>
