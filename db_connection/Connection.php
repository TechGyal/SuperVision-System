...
$database_name = "db";//Here we give the name of our database we want to connect to
 ...
 */
$connection = mysqli_connect($host, $user, $password, $database_name) or die('<center><h1>Database Connection Failed</h1></center>' . log::logData(mysqli_error($connection)));